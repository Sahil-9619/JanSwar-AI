...
import { Building2, Mail, MapPin, LogOut } from 'lucide-react-native';
  ...
  return (
    <SafeAreaView className="flex-1" style={{ backgroundColor: colors.background }}>
      ...
      <ScrollView contentContainerClassName="flex-grow justify-center px-6 py-10">
        ...
        >
          {/* MP Avatar Badge (using Orange / Amber for distinct representative theme) */}
          <View 
          ...
          <Text className="text-base font-semibold mb-6" style={{ color: '#f97316' }}>
            Welcome, MP {user?.fullName || 'Representative'}
          </Text>
          ...
          <View className="w-full space-y-4 mb-8">
            ...
            >
              <Mail size={20} color="#f97316" style={{ marginRight: 12 }} />
              <View>
            ...
            >
              <Building2 size={20} color="#f97316" style={{ marginRight: 12 }} />
              <View>
                <Text className="text-[12px] font-bold" style={{ color: colors.mutedForeground }}>Role Assigned</Text>
                <Text className="text-[15px] font-semibold" style={{ color: colors.foreground }}>{user?.role || 'MP'}</Text>
              </View>
            </View>
          </View>
