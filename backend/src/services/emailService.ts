...
<head>
  ...
  <style>
    ...
    .email-container { max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 10px 25px rgba(0, 0, 0, 0.05); }
    .email-header { background: linear-gradient(135deg, #1e3a8a 0%, #3b82f6 100%); padding: 40px 20px; text-align: center; }
    ...
    .header-subtitle { color: #bfdbfe; font-size: 14px; margin: 5px 0 0 0; font-weight: 500; }
    .email-body { padding: 40px 30px; color: #334155; }
    .greeting { font-size: 18px; font-weight: 600; margin-top: 0; color: #0f172a; }
    .message { font-size: 15px; line-height: 1.6; color: #475569; }
    .otp-container { margin: 35px 0; text-align: center; }
    .otp-box { display: inline-block; background-color: #f8fafc; border: 2px dashed #cbd5e1; border-radius: 12px; padding: 15px 35px; font-size: 38px; font-weight: 800; letter-spacing: 8px; color: #1e40af; }
    .otp-warning { font-size: 13px; color: #94a3b8; margin-top: 15px; }
    .email-footer { background-color: #f8fafc; padding: 25px 20px; text-align: center; border-top: 1px solid #e2e8f0; }
    .footer-text { font-size: 12px; color: #94a3b8; margin: 0; line-height: 1.5; }
  </style>
</head>
<body>
  <div class="email-wrapper">
    <div class="email-container">
      <div class="email-header">
        <img src="https://cdn-icons-png.flaticon.com/512/9334/9334185.png" alt="JanSwar AI Logo" class="logo-img">
        <h1 class="header-title">JanSwar <span style="color: #60a5fa;">AI</span></h1>
        <p class="header-subtitle">Constituency Intelligence Platform</p>
      </div>
      ...
      <div class="email-footer">
        <p class="footer-text">&copy; {{year}} JanSwar AI. All rights reserved.</p>
        <p class="footer-text">Secure Identity Management System</p>
      </div>
    </div>
  </div>
</body>
